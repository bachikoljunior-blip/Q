...
export const STAFF_SPEC={units:'mm',axis:'+Y',front:'+Z',right:'-X',segments:16,
  shaft:{bottom:30,top:1418,r0:18,r1:21},
...
function wrapLift(t){
  ...
  if(angle<=.9)return STAFF_SPEC.wraps.lift;if(angle>=1.25)return 0;
  const u=(angle-.9)/.35;return STAFF_SPEC.wraps.lift*(1-u*u*(3-2*u));
}
