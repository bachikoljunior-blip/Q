...
export function makeMiraRibGeometry(type){
  ...
  // Keep plate / bevel / terminal face creases: averaging across the whole
  // short end produced normals pointing behind their incident face.
  const raw=g;g=mergeVertices(toCreasedNormals(raw,Math.PI/4),1e-6);raw.dispose();
