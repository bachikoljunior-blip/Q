...
Activate when reliability, usability, performance, balance, or behavior can be measured and the data serves a real criterion or defect.

Prefer local, privacy-preserving measurements such as latency, frame time, resource use, loading time, bundle size, crashes, errors, completion, retries, encounter duration, resource economy, success rate, and abandonment.
