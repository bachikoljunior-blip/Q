...
import {createBefore,createCandidate as createDetailedActor,bodyMetric} from '../tests/fixtures/body-ground-oracle.mjs';
...
writeFileSync(new URL('../artifacts/body-comparison.json',import.meta.url),JSON.stringify(report,null,2));
