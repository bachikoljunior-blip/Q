...
const r=await build({entryPoints:['src/main.js'],bundle:true,format:'iife',minify:true,target:'es2022',write:false,outfile:'game.js',legalComments:'inline',loader:{'.glb':'dataurl','.png':'dataurl','.webp':'dataurl','.mp3':'dataurl','.wav':'dataurl'},define:{__Q_BUILD_INFO__:JSON.stringify(await buildIdentity())}});
