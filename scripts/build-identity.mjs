...
export async function buildIdentity(root=process.cwd()){
  const paths=['index.html','package.json','package-lock.json','vite.config.js','scripts/package.mjs','scripts/package-standalone.mjs','scripts/web-package.mjs','scripts/build-identity.mjs','scripts/packed-media.mjs','scripts/packed-media-plugin.mjs'];
